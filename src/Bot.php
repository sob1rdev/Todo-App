...
class Bot
{
    const string TOKEN = "7204720194:AAER7j2m7xfRpFWu368iTR4w0SVb8WwsT5M";
    ...
    {
        $user = new User();
        $user->setStatus((int)$chatId, 'delete'); // Ikkinchi argument sifatida 'delete' qiymatini beramiz
